...
func templatesAppHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/app.html", size: 770, mode: os.FileMode(420), modTime: time.Unix(1506372721, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
